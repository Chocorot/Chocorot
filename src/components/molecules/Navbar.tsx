        ...
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            <Link href="/" className="group">
              <span className="text-xl font-black group-hover:text-primary-600 transition-colors">CHOCOROT</span>
            </Link>
            ...
            <nav className="flex flex-col gap-6">
              {navLinks.map((link, i) => (
                ...
                >
                  <Link
                    href={link.href}
                    className={`text-3xl font-black uppercase hover:text-primary-600 transition-colors block py-1 ${
